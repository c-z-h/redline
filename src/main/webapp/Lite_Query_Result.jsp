...
<body style="overflow: hidden;">
    ...
    <div class="sidebar-submenu">
    <ul>
    <li><a href="Indicator_Query.html">指标体系介绍<span class="badge">2</span></a></li><li><a href="indicatorAdd.jsp">个性化指标体系服务： <span class="badge"></span></a></li>
    </ul>
    </div>
    </li>
    <li class="sidebar-dropdown">
    ...
    <form action="Lite_Query_Result" method="get" id="search_form">
	    <select class="query_select" name="query">
	    	<option value="title">按文献名称查询</option>
	        <option value="book">按文献所在期刊查询</option>
	        <option value="year">按文献发表年份查询</option>
	        <option value="author">按文献发表作者查询</option>
	        <option value="kwd">按文献关键字查询</option>
	    </select>
	    <div class="Search">
		    <div>
			    <div class="input-group">
